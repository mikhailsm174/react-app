...
export default function Navbar() {
	...
	return (
		<header className={`fixed nav_header w-full top-0 z-50 px-6 ${isScrolled ? 'bg-white text-slate-950 shadow-md' : 'bg-transparent text-white'
			} transition-all duration-500 ease-in-out`}>
			<nav className="container flex justify-between py-3 mx-auto">
				<Link to="/" className="text-2xl">
					<img className="site_logo for_small_device bg-white rounded-sm" src={SiteLogo} alt="logo" />
